...
// TODO Prevent the AI from starting every message repeating what you said
...
const createProjectModel = new ChatCohere({
  apiKey: process.env.COHERE_API_KEY,
  model: "command-r-plus"
});
const createProjectPrompt = ChatPromptTemplate.fromMessages([
  [
    "system",
...
const projectParser = StructuredOutputParser.fromNamesAndDescriptions({
  title: "Project Title",
  description: "Project Description",
});
const createProjectChain = createProjectPrompt.pipe(createProjectModel).pipe(projectParser);
export { chainWithHistory, createProjectChain, projectParser };  
