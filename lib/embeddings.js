...
const hf = new HuggingFaceInferenceEmbeddings({
    apiKey: process.env.HUGGINGFACE_API_KEY, // Replace with your Hugging Face API Key
    model: "sentence-transformers/all-MiniLM-L6-v2", // Example sentence transformer model
});
